      ...
      <div className="h-screen flex items-center">
        <div className="w-full flex flex-col items-center gap-8">
          <div className=" relative">
            <img
              className="absolute top-[-85px] left-[3px] w-[100%] object-contain h-[100px] md:top-[-87px] md:left-[22px] md:w-[90%]"
              src="./images/Donation.png"
              alt=""
            />
            <h2 className="bg-white font-breeSerif rounded-3xl bg-opacity-57 backdrop-blur-[5px] shadow-dashBoardCardImageShadow px-4 text-center pb-3 pt-3 flex justify-center items-center flex-col">
              {" "}
              <span className="text-[#40025D] font-bold animate-fade-in-donation text-[1.6rem] ">
                HELP US BRIGHTEN THEIR LIVES!
              </span>
            </h2>
          </div>
          <div className="w-30">
            ...
            <div className=" bg-white flex flex-col items-center justify-center gap-4 shadow-dashBoardCardImageShadow rounded-[40px] bg-opacity-35 p-2 pb-4 backdrop-blur-[5px]">
              <p className="text-center p-3 text-[#0b0553de] drop-shadow-xl text-[1.20rem] border-b border-black ">
                Your generous donations play a crucial role in caring for our
                little friends and helping them find their forever homes.
              </p>
              <div className="flex flex-col items-center justify-center gap-[1.0rem]">
                ...
                <div className="w-full">
                  <input
                    className="w-full outline-0 placeholder-stone inset-0 text-[#40025D] font-semibold font-baijam bg-white bg-opacity-50 shadow-dashBoardCardImageShadow rounded-[30px]  py-3 px-4"
                    type="text"
                    id="amount"
                    name="rupees"
