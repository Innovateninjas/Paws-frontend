...
function Stats() {
	...
	return (
		<>
			{/* {console.log(reports)} */}
			<Background />
			<Notification onClick={handleClick} reports={reports} />
			<div className="px-1 md:p-8 pt-0">
				<div className="flex flex-col justify-center items-center ">
					{/* <h1 className='text-4xl text-[#40025D]  tracking-[8px] bold  font-bayon'>STATISTICS</h1> */}
					<h1 className="text-[3rem] text-white tracking-[8px] font-bayon md:text-[4rem]">
						STATISTICS
					</h1>
				</div>
				<div className="px-1 md:px-[4rem] pt-2 mb-8 border-blue-200 mt-8 backdrop-blur-sm rounded-[2rem] md:mx-[5rem]">
					...
					<h1 className="ml-2 mt-2 mb-3 text-white font-Calistoga tracking-wide text-[1.6rem]">
						Number of reports
					</h1>
					...
					<MapContainer
						center={[22.5722, 88.3639]}
						zoom={13}
						style={{ height: "300px", width: "100%" }}
						className="backdrop-blur-sm bg-white/30 rounded-2xl shadow-lg mx-auto flex text-center justify-center mb-9 items-center"
					>
						<TileLayer
